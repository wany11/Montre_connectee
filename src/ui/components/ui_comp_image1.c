...
lv_obj_t * ui_Image1_create(lv_obj_t * comp_parent)
{
    ...
    lv_img_set_src(cui_Image1, &ui_img_1780325426);
    lv_obj_set_width(cui_Image1, lv_pct(68));
    lv_obj_set_height(cui_Image1, lv_pct(102));
    lv_obj_set_x(cui_Image1, -14);
    lv_obj_set_y(cui_Image1, -9);
