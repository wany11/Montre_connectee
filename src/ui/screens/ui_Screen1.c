...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Panel3, 323);
    ...
    ui_HourLabel = lv_label_create(ui_Panel3);
    ...
    ui_accel_x = lv_label_create(ui_Panel3);
    ...
    ui_accel_y = lv_label_create(ui_Panel3);
    ...
    ui_accel_z = lv_label_create(ui_Panel3);
    ...
    ui_gyro_x = lv_label_create(ui_Panel3);
    ...
    ui_gyro_y = lv_label_create(ui_Panel3);
    ...
    ui_gyro_z = lv_label_create(ui_Panel3);
    ...
    ui_mag_x = lv_label_create(ui_Panel3);
    ...
    ui_mag_y = lv_label_create(ui_Panel3);
    ...
    ui_mag_z = lv_label_create(ui_Panel3);
